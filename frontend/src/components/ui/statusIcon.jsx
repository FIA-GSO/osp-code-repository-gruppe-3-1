export default function StatusIcon({ type }) {
  const config = {
    ...
    pending:  { showIcon: true, showText: false, icon: "⏳", text: "Wartend", color: "#b45309" },
    closed:   { showIcon: true, showText: false, icon: "✕", text: "Geschlossen", color: "#b91c1c" },
    ...
    pendingText:  { showIcon: false, showText: true, icon: "⏳", text: "Wartend", color: "#b45309" },
    closedText:   { showIcon: false, showText: true, icon: "✕", text: "Geschlossen", color: "#b91c1c" },
    ...
    pendingFull:  { showIcon: true, showText: true, icon: "⏳", text: "Wartend", color: "#b45309" },
    closedFull:   { showIcon: true, showText: true, icon: "✕", text: "Geschlossen", color: "#b91c1c" }
  };
